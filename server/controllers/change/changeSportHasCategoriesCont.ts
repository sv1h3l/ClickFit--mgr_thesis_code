...
import { changeSportHasCategoriesMod } from "../../models/change/changeSportHasCategoriesMod";
import { CheckAuthorizationCodeEnum, checkAuthorizationCont } from "../residue/checkAuthorizationCont";
import { GenEnum } from "../../utilities/GenResEnum";

export const changeSportHasCategoriesCont = async (req: Request, res: Response): Promise<void> => {
	...
	try {
		...
		const dbResult = await changeSportHasCategoriesMod({ sportId, hasCategories });
