...
import { getOwnedSportsMod } from "../../models/get/getOwnedSportsMod";

export const getOwnedSportsCont = async (req: Request, res: Response): Promise<void> => {
	...
	try {
		const sports = await getOwnedSportsMod(dbUserAtr.data.userId); // Získáme sporty
