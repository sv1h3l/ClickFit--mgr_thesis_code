...
exports.changeBlacklistCont = void 0;
const changeBlacklistMod_1 = require("../../models/change/changeBlacklistMod");
const GenResEnum_1 = require("../../utilities/GenResEnum");
const checkAuthorizationCont_1 = require("../residue/checkAuthorizationCont");
const changeBlacklistCont = async (req, res) => {
    ...
    try {
        const dbResult = await (0, changeBlacklistMod_1.changeBlacklistMod)({ entityId, entityIsExercise, blacklistEntitiesIds });
...
exports.changeBlacklistCont = changeBlacklistCont;
//# sourceMappingURL=changeBlacklistCont.js.map