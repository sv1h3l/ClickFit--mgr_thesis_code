...
exports.getTrainingPlanCreationPropsCont = void 0;
...
const getTrainingPlanCreationPropsCont = async (req, res) => {
    ...
    const dbUserAtr = await (0, getUserAtrFromAuthTokenMod_1.getUserAtrFromAuthTokenMod)({ req, authToken }); // TODO předělat na checkAuth SPORT_VIEW
...
exports.getTrainingPlanCreationPropsCont = getTrainingPlanCreationPropsCont;
//# sourceMappingURL=getTrainingPlanCreationPropsCont.js.map