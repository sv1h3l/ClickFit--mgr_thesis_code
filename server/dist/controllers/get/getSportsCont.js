...
const getSportsCont = async (req, res) => {
    ...
    try {
        const sports = await (0, getSportsMod_1.getSportsMod)(dbUserAtr.data.userId); // Získáme sporty
        if (sports.length > 0) {
...
exports.getSportsCont = getSportsCont;
//# sourceMappingURL=getSportsCont.js.map