...
exports.getVisitedUserSportDetailLabsAndValsCont = void 0;
...
const getVisitedUserSportDetailLabsAndValsCont = async (req, res) => {
    ...
    try {
        ...
        let resVals = await (0, getSportDetailValsMod_1.getSportDetailValsMod)({ sportId: sportIdNumber, userId: visitedUserId });
        ...
        if (missingLabels) {
            ...
            const resCreateVals = await (0, createMissingSportDetailValsMod_1.createMissingSportDetailValsMod)({ sportId: sportIdNumber, missingSportDetailIds, userId: visitedUserId });
            ...
            resVals = await (0, getSportDetailValsMod_1.getSportDetailValsMod)({ sportId: sportIdNumber, userId: visitedUserId });
        }
...
exports.getVisitedUserSportDetailLabsAndValsCont = getVisitedUserSportDetailLabsAndValsCont;
//# sourceMappingURL=getVisitedUserSportDetailLabsAndValsCont.js.map