...
export const changeSportDetailValReq = async (props: Props): Promise<GenericApiResponse<null>> => {
	try {
		const response = await fetch("http://localhost:5000/api/change-sport-detail-value", {
			method: "POST",
			credentials: "include",
			headers: {
