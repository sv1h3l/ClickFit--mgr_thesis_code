...
export const changeGraphValueReq = async (props: Props): Promise<GenericApiResponse<null>> => {
	try {
		const response = await fetch("http://localhost:5000/api/change-graph-value", {
			method: "POST",
			credentials: "include",
			headers: {
