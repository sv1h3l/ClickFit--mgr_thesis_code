...
export const deleteSportDifficultyReq = async (props: Props): Promise<GenericApiResponse<number>> => {
	try {
		const response = await fetch("http://localhost:5000/api/delete-sport-difficulty", {
			method: "POST",
			credentials: "include",
			headers: {
